...
<div class="col-md-6">
	    <div class="form-group">
		    ...
		    {!! Form::text('first_name', null, ['class'=>'form-control','id'=>'firstname','placeholder'=>'Enter First Name']) !!}
		    
	  	</div>
	  	<div class="form-group">
		    
		    {!! Form::label('lastname' , 'Last Name') !!} 
		    {!! Form::text('last_name', null, ['class'=>'form-control','id'=>'lastname','placeholder'=>'Enter Last Name']) !!}
	  	</div>
	  	<div class="form-group">
	  ...
	  <div class="form-group">
   	...
   	<fieldset class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-10">
		    {!! Form::number('street_number', null, ['class'=>'form-control','id'=>'street_number','placeholder'=>'Enter Street Number']) !!}
		    </div>
		</div>
	  ...
	  <div class="form-group">
		...
		{!! Form::text('services',null,['class'=>'form-control','id'=>'services','required'=>'required'] ) !!}
