...
class VendorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.private.vendors.index', compact('vendors', $vendors));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.private.vendors.show', compact('vendor',$vendor));
    }
    ...
    public function edit($id)
    {
        ...
        foreach ($vendor['services'] as $key => $value) {
            ...
            $vendor['services'] = $value->name;
        }
        //dd($location);
        //dd($vendor['services']);
        return view('pages.private.vendors.edit', compact('vendor',$vendor));
    }
